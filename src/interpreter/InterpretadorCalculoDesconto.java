...
public class InterpretadorCalculoDesconto implements InterpretadorCalculo{
  private InterpretadorCalculo interpretadorInicial;

  public InterpretadorCalculoDesconto(String contexto) {

    Stack<InterpretadorCalculo> pilhaInterpretadores = new Stack<>();
